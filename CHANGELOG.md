...
- **Remove typing indicator feature** - Typing indicators are no longer sent
  - Frequently appeared after the response (timing issues)
  - Provided minimal user value
  - Required repeated fixes making it hard to maintain
  - Simplifies message handlers (text, image, file)
